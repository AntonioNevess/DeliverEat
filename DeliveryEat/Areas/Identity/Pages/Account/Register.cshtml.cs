...
namespace DeliveryEat.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// <summary>
        ///     esta inner class define os atributitos que queremos
        ///     recolher no registo
        /// </summary>
        public class InputModel
        {
            ...
            /// <summary>
            /// atributo para recolher os dados da Pessoa
            /// </summary>
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Adiciona o utilizador a role Cliente
