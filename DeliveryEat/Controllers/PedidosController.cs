...
namespace DeliveryEat.Controllers
{
    public class PedidosController : Controller
    {
        ...
        {
            ViewData["DetalhesPedidoFK"] = new SelectList(_context.DetalhesPedidos, "Id", "Id");
            ViewData["PessoaFK"] = new SelectList(_context.Pessoas, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PessoaFK,DetalhesPedidoFK")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PessoaFK,DetalhesPedidoFK")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
